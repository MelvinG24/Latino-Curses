...
IF (PDC_SDL2_DEPS_BUILD)
    ...
    set(NUEVO_PATH ${CMAKE_BINARY_DIR}/PDCursesMod/sdl2)
    ...
    ExternalProject_Add(sdl2_ext
        ...
        UPDATE_COMMAND ""
        DOWNLOAD_DIR ${CMAKE_BINARY_DIR}/PDCursesMod
        SOURCE_DIR ${CMAKE_BINARY_DIR}/PDCursesMod/SDL2-${SDL2_RELEASE}
        BUILD_IN_SOURCE 0
        CMAKE_ARGS
        ${SDL_CMAKE_BUILD_OPTS}
        -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE}
        # -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
        -DCMAKE_INSTALL_PREFIX=${NUEVO_PATH}
        -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
        )
        
        MESSAGE(STATUS "SDL2 Installing to: .... ${NUEVO_PATH}")
    # MESSAGE(STATUS "SDL2 Installing to: .... ${CMAKE_INSTALL_PREFIX}")
    SET(SDL2_INCLUDE_DIR ${NUEVO_PATH}/include/SDL2)
    SET(SDL2_LIBRARY_DIR ${NUEVO_PATH}/${CMAKE_BUILD_TYPE})
    ...
    IF (PDC_WIDE)
        ...
        ExternalProject_Add(zlib_ext
            ...
            UPDATE_COMMAND ""
            DOWNLOAD_DIR ${CMAKE_BINARY_DIR}/PDCursesMod
            SOURCE_DIR ${CMAKE_BINARY_DIR}/PDCursesMod/zlib
            BUILD_IN_SOURCE 1
            CMAKE_ARGS
        ...
        MESSAGE(STATUS "zlib Installing to: ${NUEVO_PATH}")
        # MESSAGE(STATUS "zlib Installing to: ${CMAKE_INSTALL_PREFIX}")
        SET(ZLIB_INCLUDE_DIR ${NUEVO_PATH}/include)
        SET(ZLIB_LIBRARY_DIR ${NUEVO_PATH}/${CMAKE_BUILD_TYPE})
        ...
        ExternalProject_Add(freetype2_ext
            ...
            UPDATE_COMMAND ""
            DOWNLOAD_DIR ${CMAKE_BINARY_DIR}/PDCursesMod/
            SOURCE_DIR ${CMAKE_BINARY_DIR}/PDCursesMod/freetype2
            BUILD_IN_SOURCE 0
            CMAKE_ARGS
        ...
        MESSAGE(STATUS "freetype2 Installing to: ${NUEVO_PATH}")
        # MESSAGE(STATUS "freetype2 Installing to: ${CMAKE_INSTALL_PREFIX}")
        SET(FT2_INCLUDE_DIR ${NUEVO_PATH}/include/freetype2)
        SET(FT2_LIBRARY_DIR ${NUEVO_PATH}/${CMAKE_BUILD_TYPE})
        ...
        ExternalProject_Add(sdl2_ttf_ext
            ...
            PATCH_COMMAND cmake -E copy
                ...
                ${CMAKE_BINARY_DIR}/PDCursesMod/sdl2_ttf/CMakeLists.txt
            UPDATE_COMMAND ""
            DOWNLOAD_DIR ${CMAKE_BINARY_DIR}/PDCursesMod
            SOURCE_DIR ${CMAKE_BINARY_DIR}/PDCursesMod/sdl2_ttf
            BUILD_IN_SOURCE 0
            CMAKE_ARGS
        ...
        MESSAGE(STATUS "SDL2_ttf Installing to: ${NUEVO_PATH}")
        # SET(SDL2_TTF_INCLUDE_DIR ${CMAKE_INSTALL_PREFIX}/include/SDL2_ttf)
        SET(SDL2_TTF_INCLUDE_DIR ${NUEVO_PATH}/include/SDL2_ttf)
        SET(SDL2_TTF_LIBRARY_DIR ${NUEVO_PATH}/${CMAKE_BUILD_TYPE})
